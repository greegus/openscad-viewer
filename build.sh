...
swiftc -O -target "$TARGET" -sdk "$SDK" -module-name OpenSCADViewer \
  Core/ScadRenderer.swift Core/CSGSplitter.swift Core/Annotations.swift Core/Config.swift Core/GeometryProvider.swift \
...
swiftc -O -target "$TARGET" -sdk "$SDK" -module-name ScadRenderHelper \
  Core/ScadRenderer.swift Core/CSGSplitter.swift Core/Annotations.swift Core/Config.swift Core/GeometryProvider.swift QuickLook/RenderService.swift QuickLook/Helper/main.swift \
...
swiftc -O -target "$TARGET" -sdk "$SDK" -parse-as-library -module-name ScadThumbnail \
  Core/ScadRenderer.swift Core/CSGSplitter.swift Core/Annotations.swift Core/Config.swift Core/GeometryProvider.swift QuickLook/RenderService.swift QuickLook/XPCGeometryProvider.swift QuickLook/Thumbnail/ThumbnailProvider.swift \
...
swiftc -O -target "$TARGET" -sdk "$SDK" -parse-as-library -module-name ScadPreview \
  Core/ScadRenderer.swift Core/CSGSplitter.swift Core/Annotations.swift Core/Config.swift Core/GeometryProvider.swift QuickLook/RenderService.swift QuickLook/XPCGeometryProvider.swift ViewerKit/ViewerViewController.swift ViewerKit/WebGLProbe.swift ViewerKit/ScadWebView.swift QuickLook/Preview/PreviewViewController.swift \
  -framework AppKit -framework Quartz -framework WebKit \
  -Xlinker -e -Xlinker _NSExtensionMain \
