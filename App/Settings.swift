...
/// Settings: where OpenSCAD lives and how big the render cache has grown.
/// Opened from the menu; the app itself is document-based, so this is not the main window.
final class SettingsWindowController {
    ...
    func show() {
        ...
        window.title = "OpenSCAD Viewer Settings"
